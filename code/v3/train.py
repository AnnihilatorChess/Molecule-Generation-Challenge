"""v3: Train a SCALED-UP GPT-style Transformer LM on the (non-heldout) SMILES corpus.

Compared to v2:
  - 8 layers (was 6)
  - dim 512 (was 384)
  - 8 heads (was 6); head_dim stays 64
  - 5 epochs (was 3)

~25M params, ~2.4x v2. Same tokenizer, same training file, same eval pipeline.
"""
