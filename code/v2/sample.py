"""v2: Sample from the trained Transformer LM, post-process, verify, evaluate FCD.

Mirror of v1/sample.py — only the model class differs.
"""
...
def main() -> None:
    ...
    out_path = pred_dir / f"v2_{tag}.txt"
    ...
    sum_path = pred_dir / f"v2_{tag}_summary.json"
